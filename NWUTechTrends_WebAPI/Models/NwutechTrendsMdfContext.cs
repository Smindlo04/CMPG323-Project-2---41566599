...
public partial class NwutechTrendsMdfContext : DbContext
{
    public NwutechTrendsMdfContext()
    {
    }

    public NwutechTrendsMdfContext(DbContextOptions<NwutechTrendsMdfContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=NWUTechTrends.mdf;Data Source=(LocalDB)\\MSSQLLocalDB;Initial File Name=C:\\Users\\Mpumi\\NWUTechTrends.mdf");
